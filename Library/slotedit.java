...
// ******************************************************
//
//    Slot Groups Editor  - slotedit.java
//
...
public class slotedit  extends JFrame implements ActionListener, ListSelectionListener
{
	public library L;
	...
	JLabel MembersMsg    = new JLabel("                 Member Groups for Slots  ");
	JLabel NonMembersMsg = new JLabel("               Non-Member Groups for Slots");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (source == Bok)     L.startSlotEdit();
		if (source == Bcancel) L.endSlotEdit();
