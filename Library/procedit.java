...
// ******************************************************
//
//    Processor information editor  - procedit.java
//
...
public class procedit  extends JFrame implements ActionListener, ListSelectionListener, DocumentListener
{
	public library L;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (source == SCancel) L.endProcEdit();
		...
		if (source == SDelete)
		{
			...
			String name = (String) ServiceList.get(index);
			name.trim();
