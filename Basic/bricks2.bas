   12 CLS
   20 ON KEY(13) GOSUB 20000
   30 ON KEY(12) GOSUB 30000
   40 KEY(13) ON:KEY(12) ON
  ...
  190 A$=INKEY$:G=1:H=1:IF A$=" " THEN PXINC=0
  195 FOR CO=1 TO 1500:NEXT CO
  ...
  320 END
20000 IF H=1 THEN PXINC=3
25000 RETURN
30000 IF G=1 THEN PXINC=-3
35000 RETURN
