    1 '*********************************
    2 '  Grapher program   Version 7.2
    3 '*********************************
    4 '
    5 CLS:SCREEN 0:KEY OFF
    6 LOCATE 20,1:INPUT "PASSWORD";P77$
    7  IF  P77$="WINTEX" OR P77$="wintex" OR P77$="Wintex" THEN 10 :ELSE 8
    8 IF P77$="EXIT" OR P77$="exit" OR P77$="Exit" THEN 9 :ELSE 5
    9 CLS:BEEP:KEY ON:END
   10 GOSUB 65410:CLS:BEEP:COLOR 2,0:A$="                         ":FOR QWE=1 TO 11:PRINT :NEXT
   15 PRINT A$;" Grapher program     Version 7.2 "
   17 PRINT A$;" [C] Copyright 12-SEP-91 for the "
   19 PRINT A$;" I.B.M.  Personal computer BASIC "
   21 PRINT A$;" By Master Nikhil Kumar Barthwal ":GOSUB 65404
   22 LOCATE 25,30:PRINT CHR$(16);"Press C to continue";CHR$(17)
   24 IF INKEY$="C" OR INKEY$="c" THEN 26 :ELSE 24
   26 CLS:BEEP:GOSUB 65270
   27 GOSUB 65270
   28 GOSUB 8000
   30 PI=3.14159
   40 GOSUB 10000
   45 IF ALT=1 THEN GOSUB 1601 :ELSE GOSUB 1600
   46 N=VAL(I$):IF I$="e" OR I$="E" THEN KEY 7,"gosub 65000"+CHR$(13):CLS:BEEP:RUN"MENU.BAS
 ...
 1620 RETURN
 1640 IF ASC(RIGHT$(I$,1))=45 THEN GOSUB 65000:CLS:RUN "MENU.BAS
...
10025 LOCATE 3,8,0
10030 PRINT CHR$(16);CHR$(16);CHR$(16);" Main Option Menu ";CHR$(17);CHR$(17);CHR$(17)
10040 COLOR  0,1
...
10185 COLOR 23,1
10190 PRINT :PRINT " Press C for Colours,Press E to end? "
10200 RETURN
...
40000 LOCATE 11,9:GOSUB 65230:COLOR 22,0:LOCATE 15,16:PRINT "Press RETURN":COLOR 0,7:GOSUB 30295
...
40088 COLOR 31,1:LOCATE 19,14:PRINT "PRESS RETURN";:COLOR 7,1:PLAY"ABCD"
...
65120 RETURN
65230 COLOR 4,0:LOCATE 10,6:PRINT "*********************************"
65240 COLOR 2,0:LOCATE 11,6:PRINT "  Grapher program   Version 7.2  "
65250 COLOR 4,0:LOCATE 12,6:PRINT "*********************************"
65260 GOSUB 65406:RETURN
65270 LOCATE 13,24:COLOR 4,0
65280 PRINT "Nikhil Barthwal ";:COLOR 2,0
65290 PRINT "proudly presents:":GOSUB 65406
65300 RETURN
65404 PLAY"ABCD"
65405 RETURN
65406 PLAY"ABCDCDCDCDABBCDEFG"
65407 RETURN
65410 CLS:BEEP:LOCATE 13,15
65411 PRINT "MAKE SURE CAP-LOCK IS ON"
65412 FOR QWE=1 TO 12000:NEXT
65430 CLS:RETURN
