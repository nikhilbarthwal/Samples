...
let result = [|
    ...
    "transfer9";
    "transfer10";
    "acc1(8336); acc7(8112); acc4(8103); acc0(8101); acc2(7069); acc5(6602); acc9(6414); acc6(6219); acc3(5601); acc8(5336)";
    "7919";
    "8168";
    "6676";
    "6014";
    ...
    "false";
    "false";
    "acc7(8866); acc1(8612); acc0(8607); acc4(8232); acc2(7430); acc5(7079); acc6(6895); acc9(6656); acc3(6358); acc8(6209)";
    "7571";
    "8002";
    "6395";
    "5747";
    ...
    "false";
    "false";
    "acc7(9293); acc0(8955); acc1(8778); acc4(8653); acc2(7711); acc5(7466); acc9(7115); acc6(7067); acc8(6690); acc3(6625)" |]

[<EntryPoint>]
let main _ =
    let r = Solution.Solution(queries);
    let l = r.Length - 1;
    assert (r.Length = result.Length)
    for i in [0 .. l] do
        if r[i] <> result[i] then
            printfn $"{i} -> {r[i]}  $  {result[i]}"
    0
